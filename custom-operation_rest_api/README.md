...
[Introducing the REST API Provider in SAP Landscape Management Enterprise Edition (LaMa)](https://blogs.sap.com/2022/11/30/introducing-the-rest-api-provider-in-sap-landscape-enterprise-edition-lama/)
